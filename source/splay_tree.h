...
public:
  /**
   * Constructor: splay_tree(Comparator comp = Comparator());
   * Usage: splay_tree<string, int> mySplayTree;
   * Usage: splay_tree<string, int> mySplayTree(MyComparisonFunction);
   * -------------------------------------------------------------------------
  ...
  /**
   * Copy functions: splay_tree(const splay_tree& other);
   *                 splay_tree& operator= (const splay_tree& other);
   * Usage: splay_tree<string, int> one = two;
   *        one = two;
   * -------------------------------------------------------------------------
   ...
   * Usage: for (splay_tree<string, int>::iterator itr = t.begin(); 
   *             itr != t.end(); ++itr) { ... }
   * -------------------------------------------------------------------------
   ...
   * Usage: for (splay_tree<string, int>::reverse_iterator itr = s.rbegin(); 
   *             itr != s.rend(); ++itr) { ... }
   * -------------------------------------------------------------------------
   ...
   * Usage: for (splay_tree<string, int>::iterator itr = t.lower_bound("AVL");
   ...
   * Usage: std::pair<splay_tree<int, int>::iterator, splay_tree<int, int>::iterator>
  ...
  /**
   * size_t size() const;
   * Usage: cout << "splay_tree contains " << s.size() << " entries." << endl;
   * -------------------------------------------------------------------------
...
bool operator<  (const splay_tree<Key, Value, Comparator>& lhs,
                 const splay_tree<Key, Value, Comparator>& rhs);
template <typename Key, typename Value, typename Comparator>
bool operator<= (const splay_tree<Key, Value, Comparator>& lhs,
                 const splay_tree<Key, Value, Comparator>& rhs);
template <typename Key, typename Value, typename Comparator>
...
template <typename Key, typename Value, typename Comparator>
template <typename DerivedType, typename Pointer, typename Reference>
class splay_tree<Key, Value, Comparator>::IteratorBase {
public:
  /* Utility typedef to talk about nodes. */
  typedef typename splay_tree<Key, Value, Comparator>::Node Node;
...
protected:
  /* Which splay_tree we belong to.  This pointer is const even though we are
  ...
  IteratorBase(const splay_tree* owner = NULL, Node* curr = NULL) 
 ...
 */
template <typename Key, typename Value, typename Comparator>
class splay_tree<Key, Value, Comparator>::iterator:
...
private:
   ...
   */
  iterator(const splay_tree* owner,
           typename splay_tree<Key, Value, Comparator>::Node* node) :
  ...
  /* Make the splay_tree a friend so it can call this constructor. */
...
template <typename Key, typename Value, typename Comparator>
class splay_tree<Key, Value, Comparator>::const_iterator:
  public std::iterator< std::bidirectional_iterator_tag,
...
private:
  ...
  const_iterator(const splay_tree* owner,
                 typename splay_tree<Key, Value, Comparator>::Node* node) :
    IteratorBase<const_iterator,
                 const std::pair<const Key, Value>*,
...
/**** splay_tree::Node Implementation. ****/
 ...
 */
template <typename Key, typename Value, typename Comparator>
splay_tree<Key, Value, Comparator>::Node::Node(const Key& key,
                                          const Value& value) 
  : mValue(key, value) {
  // Handled in initializer list.
}
...
/* Constructor sets up a new, empty splay_tree. */
template <typename Key, typename Value, typename Comparator>
splay_tree<Key, Value, Comparator>::splay_tree(Comparator comp) : mComp(comp) {
 ...
 */
template <typename Key, typename Value, typename Comparator>
splay_tree<Key, Value, Comparator>::~splay_tree() {
 ...
 */
template <typename Key, typename Value, typename Comparator>
std::pair<typename splay_tree<Key, Value, Comparator>::iterator, bool>
splay_tree<Key, Value, Comparator>::insert(const Key& key, const Value& value) {
 ...
 */
template <typename Key, typename Value, typename Comparator>
void splay_tree<Key, Value, Comparator>::rotateUp(Node* node) const {
 ...
 */
template <typename Key, typename Value, typename Comparator>
void splay_tree<Key, Value, Comparator>::splay(Node* node) const {
 ...
 */
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::const_iterator
splay_tree<Key, Value, Comparator>::find(const Key& key) const {
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::iterator
splay_tree<Key, Value, Comparator>::find(const Key& key) {
  /* Get the underlying const_iterator by calling the const version of this
   * function.
   */
  const_iterator itr = static_cast<const splay_tree*>(this)->find(key);
 ...
 */
template <typename Key, typename Value, typename Comparator>
std::pair<typename splay_tree<Key, Value, Comparator>::Node*,
          typename splay_tree<Key, Value, Comparator>::Node*>
splay_tree<Key, Value, Comparator>::findNode(const Key& key) const {
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::iterator
splay_tree<Key, Value, Comparator>::begin() {
  return iterator(this, mHead);
}
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::const_iterator
splay_tree<Key, Value, Comparator>::begin() const {
  return iterator(this, mHead);
}
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::iterator
splay_tree<Key, Value, Comparator>::end() {
  return iterator(this, NULL);
}
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::const_iterator
splay_tree<Key, Value, Comparator>::end() const {
  return iterator(this, NULL);
}
 ...
 */
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::reverse_iterator
splay_tree<Key, Value, Comparator>::rbegin() {
  return reverse_iterator(end());
}
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::const_reverse_iterator
splay_tree<Key, Value, Comparator>::rbegin() const {
  return const_reverse_iterator(end());
}
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::reverse_iterator
splay_tree<Key, Value, Comparator>::rend() {
  return reverse_iterator(begin());
}
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::const_reverse_iterator
splay_tree<Key, Value, Comparator>::rend() const {
  return const_reverse_iterator(begin());
}

/* size just returns the cached size of the splay tree. */
template <typename Key, typename Value, typename Comparator>
size_t splay_tree<Key, Value, Comparator>::size() const {
  return mSize;
}

/* empty returns whether the size is zero. */
template <typename Key, typename Value, typename Comparator>
bool splay_tree<Key, Value, Comparator>::empty() const {
  return size() == 0;
}
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::iterator
splay_tree<Key, Value, Comparator>::erase(iterator where) {
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::Node*
splay_tree<Key, Value, Comparator>::mergeTrees(Node* lhs, Node* rhs) const {
 ...
 */
template <typename Key, typename Value, typename Comparator>
bool splay_tree<Key, Value, Comparator>::erase(const Key& key) {
...
template <typename Key, typename Value, typename Comparator>
Value& splay_tree<Key, Value, Comparator>::operator[] (const Key& key) {
...
template <typename Key, typename Value, typename Comparator>
const Value& splay_tree<Key, Value, Comparator>::at(const Key& key) const {
 ...
 */
template <typename Key, typename Value, typename Comparator>
Value& splay_tree<Key, Value, Comparator>::at(const Key& key) {
  return const_cast<Value&>(static_cast<const splay_tree*>(this)->at(key));
}
 ...
 */
template <typename Key, typename Value, typename Comparator>
splay_tree<Key, Value, Comparator>::splay_tree(const splay_tree& other) {
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::Node*
splay_tree<Key, Value, Comparator>::cloneTree(Node* toClone, Node* parent) {
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::Node*
splay_tree<Key, Value, Comparator>::rethreadLinkedList(Node* root, Node* predecessor) {
...
template <typename Key, typename Value, typename Comparator>
splay_tree<Key, Value, Comparator>&
splay_tree<Key, Value, Comparator>::operator= (const splay_tree& other) {
  splay_tree clone = other;
  swap(clone);
  return *this;
}
...
template <typename Key, typename Value, typename Comparator>
void splay_tree<Key, Value, Comparator>::swap(splay_tree& other) {
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::const_iterator
splay_tree<Key, Value, Comparator>::lower_bound(const Key& key) const {
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::iterator
splay_tree<Key, Value, Comparator>::lower_bound(const Key& key) {
  /* Call the const version to get the answer. */
  const_iterator result = static_cast<const splay_tree*>(this)->lower_bound(key);
 ...
 */
template <typename Key, typename Value, typename Comparator>
std::pair<typename splay_tree<Key, Value, Comparator>::const_iterator,
          typename splay_tree<Key, Value, Comparator>::const_iterator>
splay_tree<Key, Value, Comparator>::equal_range(const Key& key) const {
...
template <typename Key, typename Value, typename Comparator>
std::pair<typename splay_tree<Key, Value, Comparator>::iterator,
          typename splay_tree<Key, Value, Comparator>::iterator>
splay_tree<Key, Value, Comparator>::equal_range(const Key& key) {
  /* Invoke const version to get the iterators. */
  std::pair<const_iterator, const_iterator> result =
    static_cast<const splay_tree*>(this)->equal_range(key);
...
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::iterator
splay_tree<Key, Value, Comparator>::upper_bound(const Key& key) {
  return equal_range(key).second;
}
template <typename Key, typename Value, typename Comparator>
typename splay_tree<Key, Value, Comparator>::const_iterator
splay_tree<Key, Value, Comparator>::upper_bound(const Key& key) const {
  return equal_range(key).second;
}
