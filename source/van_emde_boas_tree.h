...
public:
  /**
   * Constructor: van_emde_boas_tree();
   * Usage: van_emde_boas_tree myTree;
   * --------------------------------------------------------------------------
   * Constructs a new, empty vEB-tree.
   */
  van_emde_boas_tree();

  /* Destructor: ~van_emde_boas_tree();
   * Usage: (implicit)
   * --------------------------------------------------------------------------
  ...
  /**
   * Copy functions: van_emde_boas_tree(const van_emde_boas_tree& other);
   *                 van_emde_boas_tree& operator= (const van_emde_boas_tree& other);
   * Usage: van_emde_boas_tree one = two;
   *        one = two;
   * --------------------------------------------------------------------------
   * Sets this van_emde_boas_tree to be a deep-copy of some other vEB-tree.
   */
  van_emde_boas_tree(const van_emde_boas_tree& other);
  van_emde_boas_tree& operator= (const van_emde_boas_tree& other);
   ...
   * Usage: for (van_emde_boas_tree::const_iterator itr = tree.begin();
   *             itr != tree.end(); ++itr) { ... }
   * --------------------------------------------------------------------------
   ...
   * Usage: for (van_emde_boas_tree::const_reverse_iterator itr = tree.rbegin();
   *             itr != tree.rend(); ++itr) { ... }
   * --------------------------------------------------------------------------
   * Returns a range of iterators delineating the full contents of this
   * van_emde_boas_tree in reverse order.
   */
  const_reverse_iterator rbegin() const;
  const_reverse_iterator rend() const;
   ...
   * Usage: van_emde_boas_tree::const_iterator itr = tree.predecessor(137);
  ...
  /**
   * void swap(van_emde_boas_tree& rhs);
...
class van_emde_boas_tree::const_iterator:
...
private:
  /* Make van_emde_boas_tree a friend of this class so it can invoke the private
   * constructor.
   */
  friend class van_emde_boas_tree;

  /* Constructor creates an iterator that starts off at the specified value. */
  const_iterator(size_t valueOrSentinel, const van_emde_boas_tree* owner);
   ...
   */
  size_t mCurr;
  const van_emde_boas_tree* mOwner;
};
}// namespace util
#endif